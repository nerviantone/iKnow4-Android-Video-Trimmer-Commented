...
public class VideoCursorLoader implements LoaderManager.LoaderCallbacks<Cursor>, ILoader {
  ...
  private SimpleCallback mSimpleCallback; // implements CallBack Interface with 2 not defined methods but does nothing method called
  //  success(T t),failure(V v)

  // implementing load method from ILoader interface
